...
export const StaggeredMenu: React.FC<StaggeredMenuProps> = ({
  position = 'right',
  colors = ['#081F5C', '#334EAC', '#BAD6EB', '#F7F2EB'],
  items = [],
  socialItems = [],
  displaySocials = true,
  displayItemNumbering = true,
  className,
  menuButtonColor = '#EDF1F6',
  openMenuButtonColor = '#BAD6EB',
      ...
      >
        ...
        <aside
          ...
          style={{
            ...
            background:
              'linear-gradient(160deg, rgba(8,15,40,0.98) 0%, rgba(8,31,92,0.96) 45%, rgba(2,8,25,0.96) 100%)',
          }}
          aria-hidden={!open}
        >
...
.sm-scope .sm-toggle { position: relative; display: inline-flex; align-items: center; gap: 0.3rem; background: transparent; border: none; cursor: pointer; color: #EDF1F6; font-weight: 500; line-height: 1; overflow: visible; }
...
.sm-scope .staggered-menu-panel { position: absolute; top: 0; right: 0; width: clamp(260px, 38vw, 420px); height: 100%; backdrop-filter: blur(14px); -webkit-backdrop-filter: blur(14px); display: flex; flex-direction: column; padding: 6.5em 2.25em 2.25em 2.25em; overflow-y: auto; z-index: 10; }
...
.sm-scope .sm-socials-title { margin: 0; font-size: 1.05rem; font-weight: 500; color: var(--sm-accent, #BAD6EB); }
...
.sm-scope .sm-socials-link:focus-visible { outline: 2px solid var(--sm-accent, #BAD6EB); outline-offset: 3px; }
...
.sm-scope .sm-socials-link:hover { color: var(--sm-accent, #BAD6EB); }
.sm-scope .sm-panel-title { margin: 0; font-size: 1rem; font-weight: 600; color: #BAD6EB; text-transform: uppercase; }
...
.sm-scope .sm-panel-item:hover { color: var(--sm-accent, #BAD6EB); }
.sm-scope .sm-panel-list[data-numbering] { counter-reset: smItem; }
.sm-scope .sm-panel-list[data-numbering] .sm-panel-item::after { counter-increment: smItem; content: counter(smItem, decimal-leading-zero); position: absolute; top: 0.1em; right: 3.2em; font-size: 18px; font-weight: 400; color: var(--sm-accent, #BAD6EB); letter-spacing: 0; pointer-events: none; user-select: none; opacity: var(--sm-num-opacity, 0); }
